    ...
    return (
      <Link to={`/auctions/${auction.id}`}>
        <Card className="hover:shadow-md transition-shadow">
          <div className="flex">
            <div className="w-32 h-32 sm:w-40 sm:h-40 bg-muted flex items-center justify-center flex-shrink-0 rounded-l-lg">
            ...
            <div className="flex-1 p-4 flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between mt-3">
                <div>
                  ...
                  <p className="text-xl font-bold text-primary">${parseFloat(auction.currentPrice).toLocaleString()}</p>
                </div>
      ...
      <Card className="h-full hover:shadow-md transition-shadow flex flex-col">
        ...
        <CardFooter className="p-4 pt-0 flex flex-col gap-2">
          <div className="w-full flex items-center justify-between">
            <div>
              <p className="text-xs text-muted-foreground">Current Price</p>
              <p className="text-lg font-bold text-primary">${parseFloat(auction.currentPrice).toLocaleString()}</p>
            </div>
            {auction.bidCount !== undefined && (
